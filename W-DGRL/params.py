...
# args for or-tools
parser.add_argument('--max_solve_time', type=int, default=7200, help='The maximum solving time of OR-Tools')
...
parser.add_argument('--prune_pct', type=int, default='20', help='percentage for operation embedding graph pruning')
parser.add_argument('--fea_idx', type=int, default='7', help='feature index (7:remaining number of operations, 8 remaining workload)')
parser.add_argument('--sparse_mm', type=int, default='0', help='sparse_mm')
