...
from data_utils import load_data_from_files, CaseGenerator, SD2_instance_generator, load_data_from_all_files
...
class Trainer:
    def __init__(self, config):
        ...
        self.test_data = load_data_from_all_files(self.test_data_path)
        # validation data set
        vali_data = load_data_from_all_files(self.vali_data_path)
